---
title: "APS employment data report"
...
## About this report
This analysis is based on data from the Annual Population Survey (APS), a continuous household survey covering the UK. Topics covered by the survey include employment and unemployment, as well as housing, ethnicity, religion, health and education.  
...
In 2023, an estimated 41% of the film and video production workforce was based in London and the South East.^[The South East region wraps around London so includes the major studios to the west of the city.] This compares with 29% for the UK workforce as a whole (@fig-employment-location).

::: {.callout-warning collapse="false"}
## Sample size and data coverage 

Film and video production workforce estimates by region should be treated with caution as employment estimates by region are not available for many areas including:

* Inner London (for employees) 
* Central London and Outer London (for self-employed workers)

Estimates are not available due to small sample sizes. Sample size may also explain, at least in part, the variation in the percentage of London and South East employment in the film and video production sector over the past decade, as seen in @fig-employment-location.
:::
